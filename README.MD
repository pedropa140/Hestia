...
1. Setup Django install `pip install Django`
2. Setup corsheaders `pip install django-cors-headers`
3. Create your `.venv` environment through the VSCode interface or terminal.
